...
async fn test_list_tools() {
    ...
    let (status, json) = common::get_json_with_token(&app, "/api/service/tools", &token).await;
...
async fn test_doc_with_replicates() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/doc/calculate",
        &serde_json::json!({
...
async fn test_alkalinity() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/alkalinity/calculate",
        &serde_json::json!({
...
async fn test_ion_charge_balance() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/ions/calculate",
        &serde_json::json!({
            "cations": [
...
async fn test_isotopes() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/isotopes/calculate",
        &serde_json::json!({
            "d_d": -102.5,
            "d18o": -13.98,
            "d17o": -7.42
...
async fn test_field_data() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/field_data/calculate",
        &serde_json::json!({
            "elevation_m": 1936.0,
            "temp_c": 6.7,
            "raw_co2_avg": 512.0,
...
async fn test_pco2_simple() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/pco2/calculate",
        &serde_json::json!({
            "co2_aq_umol": 15.0,
            "water_temp_c": 6.7,
            "variant": "simple"
...
async fn test_dic() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/dic/calculate",
        &serde_json::json!({
...
async fn test_nutrients_multi_species() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/nutrients/calculate",
        &serde_json::json!({
            "species": {
...
async fn test_tss_afdm() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/tss_afdm/calculate",
        &serde_json::json!({
            "wgt_dried_g": 0.1025,
...
async fn test_dom_indices() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/dom/calculate",
        &serde_json::json!({
            "a254": 0.085,
            "doc_avg_ppb": 192.0,
            "peak_a": 0.054,
...
async fn test_co2_air() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/co2_air/calculate",
        &serde_json::json!({
            "co2_wet": 415.0,
            "ch4_wet": 1.95,
            "h2o_percent": 1.2
...
async fn test_chlorophyll_acid() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/chlorophyll/calculate",
        &serde_json::json!({
            "method": "acid",
...
async fn test_benthic() {
    ...
    let (status, json) = common::post_json_parse_with_token(
        &app,
        "/api/service/tools/benthic/calculate",
        &serde_json::json!({
...
async fn test_unknown_tool() {
    ...
    let (status, _) = common::post_json_with_token(
        &app,
        "/api/service/tools/nonexistent/calculate",
        &serde_json::json!({}),
        &token,
    )
    .await;
