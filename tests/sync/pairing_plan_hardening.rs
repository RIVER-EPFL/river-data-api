...
async fn pair_action_on_empty_parameter_name_is_rejected() {
    ...
    insert_plan(&db, forced_plan, &serde_json::json!([{
        ...
        "instrument": { "id": null, "name": "Unnamed probe", "source_key": "hardening:hard-empty-2", "resolved_by": "placeholder", "create": true, "confirmed": true, "stamps_readings": false },
        "confidence": "none",
        "warnings": [],
        "acknowledged": true,
...
async fn apply_is_refused_while_a_row_still_needs_checking() {
    ...
    let unchecked = serde_json::json!([{
        ...
        "instrument": { "id": null, "name": "Turbidity", "source_key": "HARD:Turbidity", "resolved_by": "placeholder", "create": true, "confirmed": true, "stamps_readings": false },
        "confidence": "none",
        "warnings": [],
        "acknowledged": false,
    }]);
