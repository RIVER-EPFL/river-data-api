...
//!
//! Run: cargo test --test alarm_no_autocreate_test -- --test-threads=1
...
async fn site_parameter_create_does_not_auto_create_or_shadow_threshold() {
    ...
    let depth = common::GLOBAL_PARAM_DEPTH_ID;
    let site2 = common::SITE2_ID; // seed does not give SITE2 a Depth site_parameter
