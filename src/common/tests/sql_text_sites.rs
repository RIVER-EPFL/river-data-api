...
const ALLOWED: &[(&str, usize, usize)] = &[
    ...
    // A catalog read of `information_schema`.
    ("src/routes/private/derived_parameters/service.rs", 1, 0),
    ...
    ("src/routes/private/notifications/flows.rs", 5, 8),
    ("src/routes/private/notifications/service.rs", 16, 0),
    ("src/routes/private/notifications/views.rs", 1, 0),
    ...
    ("src/routes/private/readings/service.rs", 11, 55),
    ("src/routes/private/readings/views.rs", 0, 1),
    ...
    ("src/routes/private/sensor_calibrations/service.rs", 2, 93),
