...
#[openapi(
    paths(
        ...
        private::sensor_calibrations::window::get_calibration_window,
    ...
    components(
        schemas(
            ...
            private::sensor_calibrations::window::CalibrationWindowPoint,
            private::sensor_calibrations::window::CalibrationWindowResponse,
