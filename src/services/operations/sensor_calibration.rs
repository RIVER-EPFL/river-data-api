...
use crate::services::calibration::{recompute_valid_until, spawn_reprocessing_job};
...
impl CRUDOperations for SensorCalibrationOperations {
    ...
    async fn after_create(
        ...
        spawn_reprocessing_job(db, entity.sensor_id, "calibration_create", Some(entity.id))
            .await
            .map_err(ApiError::database)?;
    ...
    async fn after_update(
        ...
        spawn_reprocessing_job(db, entity.sensor_id, "calibration_update", Some(entity.id))
            .await
            .map_err(ApiError::database)?;
    ...
    async fn perform_delete(
        ...
        // Clear FK references on readings before deleting
        ...
        spawn_reprocessing_job(db, sensor_id, "calibration_delete", Some(id))
            .await
            .map_err(ApiError::database)?;
